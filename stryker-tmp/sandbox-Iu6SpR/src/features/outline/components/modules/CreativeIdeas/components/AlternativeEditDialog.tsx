...
const AlternativeEditDialog: React.FC<AlternativeEditDialogProps> = ({
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth='md' fullWidth>
      <DialogTitle>{editingAlternative ? '编辑替代方案' : '添加新替代方案'}</DialogTitle>
      <DialogContent>
        <Box component='form' sx={{ mt: 2 }}>
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={6}>
              ...
              <Button size='small' startIcon={<AddIcon />} onClick={() => onAddListItem('pros')}>
                添加优点
              </Button>
            </Grid>
            ...
            <Grid item xs={12} md={6}>
              ...
              <Button size='small' startIcon={<AddIcon />} onClick={() => onAddListItem('cons')}>
                添加缺点
              </Button>
            </Grid>
