...
import { Box, Card, CardContent, CardActions, Typography, IconButton, Chip } from '@mui/material';
...
const SubplotCard: React.FC<SubplotCardProps> = ({ subplot, characters, onEdit, onDelete }) => {
