    ...
    <Paper elevation={1} sx={{ p: 2 }}>
      ...
      <List dense>
        <ListItem>
          ...
          <ListItemText primary='章节长度平衡' secondary='每章字数相对均衡，避免某章过长或过短' />
        </ListItem>
        <ListItem>
          <ListItemIcon>•</ListItemIcon>
          <ListItemText primary='情节起伏节奏' secondary='高潮低潮交替，给读者适当的缓冲时间' />
        </ListItem>
        <ListItem>
          <ListItemIcon>•</ListItemIcon>
          <ListItemText primary='角色发展连贯' secondary='确保主要角色在各章节中有连续的发展轨迹' />
        </ListItem>
        <ListItem>
          <ListItemIcon>•</ListItemIcon>
          <ListItemText primary='线索伏笔呼应' secondary='前后章节的伏笔和呼应要有明确的对应关系' />
        </ListItem>
      </List>
    </Paper>
  );
