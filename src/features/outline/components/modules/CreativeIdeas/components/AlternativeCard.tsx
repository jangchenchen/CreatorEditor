...
const AlternativeCard: React.FC<AlternativeCardProps> = ({ alternative, onEdit, onDelete }) => {
  const handleDelete = () => {
      ...
      <CardContent>
        ...
        <Box sx={{ mb: 3 }}>
          ...
          <Paper sx={{ p: 2, bgcolor: 'info.50' }}>
            <Typography variant='body1'>{alternative.originalElement}</Typography>
          </Paper>
        </Box>
        ...
        <Box sx={{ mb: 3 }}>
          ...
          <Paper sx={{ p: 2, bgcolor: 'primary.50' }}>
            <Typography variant='body1'>{alternative.alternativeVersion}</Typography>
          </Paper>
        </Box>
        ...
        {alternative.impact && (
          <Box sx={{ mt: 3 }}>
            ...
            <Paper sx={{ p: 2, bgcolor: 'warning.50' }}>
              <Typography variant='body2'>{alternative.impact}</Typography>
            </Paper>
          </Box>
        )}
      </CardContent>
