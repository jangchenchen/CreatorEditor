      ...
      <AccordionDetails>
        <Box sx={{ mb: 2 }}>
          <Typography variant="body2" color="text.secondary" paragraph>
            平均每章副线数: {averagePerChapter.toFixed(1)} | 
                ...
                <TableRow key={chapterId}>
                  ...
                  <TableCell>
                    <Box sx={{ 
                      ...
                      height: 20, 
                      bgcolor: count > averagePerChapter * 1.5 ? 'error.main' : 
                               count > averagePerChannel ? 'warning.main' : 'success.main',
                      borderRadius: 1,
                      display: 'flex',
                      alignItems: 'center',
                      ...
                      {count > averagePerChapter * 1.5 ? '密集' :
                       count > averagePerChapter ? '适中' : '稀疏'}
                    </Box>
                  </TableCell>
                </TableRow>
              ))}
