...
export const CharacterEditDialog: React.FC<CharacterEditDialogProps> = ({
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth='md' fullWidth>
      <DialogTitle>{editMode ? '编辑角色' : '新增角色'}</DialogTitle>
      <DialogContent>
        <Box sx={{ pt: 1 }}>
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              <TextField
                ...
                onChange={e =>
                  onCharacterChange(prev => (prev ? { ...prev, appearance: e.target.value } : null))
                }
            ...
            <Grid item xs={12}>
              <TextField
                ...
                onChange={e =>
                  onCharacterChange(prev => (prev ? { ...prev, goals: e.target.value } : null))
                }
